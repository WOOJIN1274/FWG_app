...
page = st.sidebar.selectbox(
    "페이지 선택",
    ("조수기 메뉴얼", "재고관리", "Trouble Shooting", "조수기 작업", "RAG", "QR 코드 생성")
)
...
if page == "조수기 메뉴얼":
    ...
    RAG_link = st.link_button("Go to RAG", url="https://google.com")
    GPT_link = st.link_button("Go to GPT", url="https://chatgpt.com")
elif page == "QR 코드 생성":
